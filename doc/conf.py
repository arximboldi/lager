...
breathe_projects = { "lager": "_doxygen/xml" }
breathe_default_project = "lager"
...
html_theme_options = {
    "project_nav_name": "lager",
    "github_link" : "https://github.com/arximboldi/lager",
}
...
latex_documents = [
    (master_doc, 'lager.tex', u'lager Documentation',
...
man_pages = [
    (master_doc, 'lager', u'lager Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lager', u'lager Documentation',
     author, 'lager', 'One line description of project.',
     'Miscellaneous'),
]
